...
import {AiFillGithub, AiFillYoutube, AiFillInstagram, AiFillLinkedin} from 'react-icons/ai' 
...
const socialLinks = [
  ...
  {
    path: "https://github.com/ishit1011",
  ...
  {
    path: "https://www.linkedin.com/in/ishit-singh-a879a3227/",
    icon: <AiFillLinkedin className='group-hover: text-black w-4 h-5 ' />
  }
];
      ...
      <div className="flex justify-between flex-col md:flex-row flex-wrap gap-[30px]">
        <div>
          ...
          <p className="text-[16px] leading-7 font-[400] text-textColor mt-4 ">
            Copyright © {year} developed by Ishit Singh all right reserved.
          </p>
