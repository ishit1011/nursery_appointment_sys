export const services = [
    ...
    {
      name: "Succulents",
      desc: "Low-maintenance and trendy, our succulents come in a variety of shapes and sizes, ideal for indoor and outdoor spaces.",
      bgColor: "rgba(60, 179, 113, .2)",
      textColor: "#3CB371",
    },
    {
      name: "Daisies",
    ...
    {
      name: "Lilies",
      desc: "Elegant and fragrant, lilies are perfect for gardens and floral arrangements, available in a variety of stunning colors.",
      bgColor: "rgba(255, 140, 0, .2)",
      textColor: "#FF8C00",
    },
    {
      name: "Marigolds",
      desc: "Bright and hardy, marigolds bring a splash of color to any garden and are known for their pest-repelling properties.",
      bgColor: "rgba(255, 165, 0, .2)",
      textColor: "#FFA500",
    },
    {
      name: "Hydrangeas",
