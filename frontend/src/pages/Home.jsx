            ...
            <div>
              <div className="lg:w-[570px] ">
                <h1 className='text-[36px] leading-[46px] text-headingColor font-[800] md:text-[60px] md:leading-[70px] '>
                  We help people get their favourite plants.
                </h1>
                <p className="text__para">
                  Lorem ipsum dolor sit amet consectetur adipisicing elit. 
                  Optio hic dignissimos rem, placeat assumenda veritatis 
                  possimus animi quam, amet quibusdam iure dicta distinctio 
                  adipisci excepturi quis.
                </p>
              ...
              <div className="mt-[30px] lg:mt-[70px] flex flex-col lg:flex-row lg:items-center gap-5 lg:gap-[30px] ">
                <div>
                  <h2 className="text-[36px] leading-[56px] lg:text-[44px] lg:leading-[54px] font-[7] text-headingColor ">
                    25+
                  </h2>
                ...
                <div>
                  ...
                  <p className='text__para'>Nursery Locations</p>
                </div>
        ...
        <div className="container">
          <div className="lg:w-[470px] mx-auto ">
            <h2 className="heading text-center">
              Providing finest plant nursery services
            </h2>
        ...
        <div className="container">
          ...
          <div className="xl:w-[670px] ">
            <h2 className="heading">
              Connect virtually <br /> anytime.
            </h2>

            <ul className="pl-4">
              <li className="text__para">
                1. Schedule appointment through our website.
              </li>
              <li className="text__para">
                2. Search for the nursery of your choice and contact the owner.
              </li>
              <li className="text__para">
                3. View the nurseries who are available and use the scheduling tool to select an appointment time of ur choice.
              </li>
            </ul>
